      ...
      <SafeAreaView style={Styles.contant}>
          ...
          <View style={{ gap: 80 }}>
              <View style={Styles.sign}>
                  ...
                  <View style={{marginTop:20}}>
                      <Text style={{color:erroremail?"red":"blue",marginTop:5}}>ComfirmePassword</Text>
                      <View style={[Styles.input,{borderColor:erroremail?"red":"blue"}]}>
                          <TextInput value={comfirme} style={{flexGrow:2,fontSize:20}} onChangeText={setComfirme} />
                          <Entypo name="home" size={24} color="#008E97" />
                      </View>
                      {errcomfirme&&<Text style={Styles.error}>{errcomfirme}</Text>}
                  </View>
                  <View>
                      <Text style={{color:errorPass?"red":"blue",marginTop:10}}>Name</Text>
                      <View style={[Styles.input,{borderColor:errorPass?"red":"blue"}]}>
                          <TextInput value={name} secureTextEntry={sec} style={{flexGrow:2,fontSize:20}} onChangeText={setName} />
                          <TouchableOpacity onPress={() => setSec(!sec)}>
                              {sec?
                              <Entypo name="home" size={24} color="#008E97" />:
                              <Entypo name="home" size={24} color="red" />}
              ...
              <TouchableOpacity onPress={handleRegisterogin}>
                  <LinearGradient
